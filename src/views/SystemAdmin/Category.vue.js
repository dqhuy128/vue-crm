...
const fetchDataDocument = () => {
    ...
    debounceTime.value.timeOut = setTimeout(() => {
        ...
        doFetch(`${apiUri}/categories/list?${new URLSearchParams(Object.fromEntries(Object.entries(res).map(([key, value]) => [key, String(value)]))).toString()}`, auth.token()).then(() => {
...
if (__VLS_ctx.toggleBoxFilters) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
        ...
        ...{ class: "xxl:gap-4 flex flex-wrap gap-2" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    var __VLS_58;
    var __VLS_54;
    for (const [item, key] of __VLS_getVForSourceType((__VLS_ctx.selectData))) {
...
if (__VLS_ctx.checkPermission('Categories', 'List')) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    if (__VLS_ctx.dataDocument.doc) {
        for (const [item, index] of __VLS_getVForSourceType((__VLS_ctx.dataDocument.doc.items))) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                key: (index),
                ...{ class: "table-item justify-between" },
            });
            for (const [it, _] of __VLS_getVForSourceType((item))) {
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    ...{ class: "cell" },
                });
                if (index < 9) {
                ...
                (it.description);
                if (Number(it.status) === 1) {
                    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                        ...{ class: "cell status status-green status-body" },
                    });
                }
                if (Number(it.status) === 0 || it.status === null) {
                    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                        ...{ class: "cell status status-red status-body" },
                    });
                }
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
/** @type {[typeof ModalAddCategory, typeof ModalAddCategory, ]} */ ;
// @ts-ignore
const __VLS_86 = __VLS_asFunctionalComponent(ModalAddCategory, new ModalAddCategory({
    ...{ 'onPostRequest': {} },
...
// @ts-ignore
const __VLS_100 = __VLS_asFunctionalComponent(ModalCategoryUpdate, new ModalCategoryUpdate({
    ...{ 'onPostRequestEdit': {} },
...
//# sourceMappingURL=Category.vue.js.map