...
const fetchDataDocument = () => {
    ...
    debounceTime.value.timeOut = setTimeout(() => {
        ...
        doFetch(`${apiUri}/document/list?${new URLSearchParams(Object.fromEntries(Object.entries(res).map(([key, value]) => [key, String(value)]))).toString()}`, auth.token()).then(() => {
...
const checkEditId = (id) => {
    // Check if the user is an admin or the document creator
    return userInfo.value?.role === 'admin' || String(id) === String(userInfo.value?.id);
};
...
const categoryDocument = reactive({
    data: computed(() => Object.keys(dataDocument.doc?.items || {}).map((key) => {
        return dataDocument.doc?.items[key][0];
    })),
});
function findCategoryName(typeId) {
...
if (__VLS_ctx.toggleBoxFilters) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
        ...{ onSubmit: (__VLS_ctx.handleSearchDocument) },
    ...
    const __VLS_12 = __VLS_asFunctionalComponent(__VLS_11, new __VLS_11({
        modelValue: (__VLS_ctx.params.type_id),
    }));
    ...
    var __VLS_58;
    var __VLS_54;
    for (const [item, index] of __VLS_getVForSourceType((__VLS_ctx.dataTypeDocument.data))) {
    ...
    var __VLS_50;
    var __VLS_46;
    const __VLS_67 = {}.SelectScrollDownButton;
...
if (__VLS_ctx.checkPermission('Document', 'Create')) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (...[$event]) => {
                if (!(__VLS_ctx.checkPermission('Document', 'Create')))
                    return;
                __VLS_ctx.toggleModal('modalAddDocument');
            } },
        id: "tableAdding",
        type: "button",
...
if (__VLS_ctx.checkPermission('Document', 'List')) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "cell edit !justify-center" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        id: "tableRowBody",
        ...{ class: "body table-row" },
    });
    if (__VLS_ctx.dataDocument.doc) {
        for (const [document, index] of __VLS_getVForSourceType((__VLS_ctx.dataDocument.doc.items))) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                key: (index),
                ...{ class: "table-item justify-between" },
            });
            for (const [item, _] of __VLS_getVForSourceType((document))) {
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    ...{ class: "cell" },
                });
                (index + 1);
                ...
                if (__VLS_ctx.categoryDocument.data) {
                    (__VLS_ctx.findCategoryName(item.type_id));
                }
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    ...{ class: "cell" },
                });
                ...
                (item.created_at);
                if (__VLS_ctx.permissionList) {
                    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                        ...{ class: "cell pinned pinned-body" },
                    });
                    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                        ...{ class: "cell edit edit-body justify-end" },
                    });
                    if (item.link) {
                        __VLS_asFunctionalElement(__VLS_intrinsicElements.a, __VLS_intrinsicElements.a)({
                            href: (item.link),
                            target: "_blank",
                            ...{ class: "cell-btn-view me-auto shrink-0 cursor-pointer" },
                        });
                        __VLS_asFunctionalElement(__VLS_intrinsicElements.img)({
                    ...
                    if (__VLS_ctx.checkPermission('Document', 'Update') && __VLS_ctx.checkEditId(item.user_id)) {
                        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                            ...{ onClick: (...[$event]) => {
                                    if (!(__VLS_ctx.checkPermission('Document', 'List')))
                                        return;
                                    ...
                                    if (!(__VLS_ctx.checkPermission('Document', 'Update') && __VLS_ctx.checkEditId(item.user_id)))
                                        return;
                                    __VLS_ctx.handleEditDocument(item.id);
                                } },
                            type: "button",
                    ...
                    if (__VLS_ctx.checkPermission('Document', 'Delete') && __VLS_ctx.checkEditId(item.user_id)) {
                        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
                            ...{ onClick: (...[$event]) => {
                                    if (!(__VLS_ctx.checkPermission('Document', 'List')))
                                        return;
                                    ...
                                    if (!(__VLS_ctx.checkPermission('Document', 'Delete') && __VLS_ctx.checkEditId(item.user_id)))
                                        return;
                                    __VLS_ctx.confirmDeleteDocument(item.id);
                                } },
                            type: "button",
...
const __VLS_79 = __VLS_asFunctionalComponent(Modal, new Modal({
    ...{ 'onClose': {} },
    modalActive: (__VLS_ctx.modalActive.modalAddDocument),
...
/** @type {[typeof CreateDocument, typeof CreateDocument, ]} */ ;
// @ts-ignore
const __VLS_86 = __VLS_asFunctionalComponent(CreateDocument, new CreateDocument({
    ...{ 'onPostRequest': {} },
    propFunction: (__VLS_ctx.fetchDataDocument),
    propData: (__VLS_ctx.dataTypeDocument.data),
}));
...
/** @type {[typeof Modal, typeof Modal, ]} */ ;
// @ts-ignore
const __VLS_93 = __VLS_asFunctionalComponent(Modal, new Modal({
    ...{ 'onClose': {} },
    modalActive: (__VLS_ctx.modalActive.modalEditDocument),
    maxWidth: "max-w-[670px]",
}));
...
const __VLS_99 = {
    onClose: (...[$event]) => {
        __VLS_ctx.toggleModal('modalEditDocument');
    }
};
...
/** @type {[typeof EditDocument, typeof EditDocument, ]} */ ;
// @ts-ignore
const __VLS_100 = __VLS_asFunctionalComponent(EditDocument, new EditDocument({
    ...{ 'onPostRequestEdit': {} },
    closeModal: (() => __VLS_ctx.toggleModal('modalEditDocument')),
    propFunction: (__VLS_ctx.fetchDataDocument),
    data: (__VLS_ctx.detailDocument),
    propData: (__VLS_ctx.dataTypeDocument.data),
}));
...
/** @type {[typeof Modal, typeof Modal, ]} */ ;
// @ts-ignore
const __VLS_107 = __VLS_asFunctionalComponent(Modal, new Modal({
    ...{ 'onClose': {} },
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.handleDeleteDocument) },
    type: "submit",
...
if (__VLS_ctx.dataPostRequest?.errors) {
    const __VLS_126 = {}.ToastDescription;
...
if (__VLS_ctx.dataPostRequestEdit?.errors) {
    const __VLS_146 = {}.ToastDescription;
    /** @type {[typeof __VLS_components.ToastDescription, typeof __VLS_components.ToastDescription, ]} */ ;
    // @ts-ignore
...
/** @type {__VLS_StyleScopedClasses['cell-btn-view']} */ ;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            handleSearchDocument: handleSearchDocument,
...
//# sourceMappingURL=Document.vue.js.map