...
const __VLS_4 = __VLS_asFunctionalComponent(BreadcrumsNew, new BreadcrumsNew({
    breadcrumbList: (__VLS_ctx.breadcrumbList),
}));
...
__VLS_14.slots.default;
{
    ...
    if (column.dataIndex === 'status') {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: (__VLS_ctx.statusColor[record.status === 'Đã duyệt'
                    ? 'success'
                    : record.status === 'Chưa duyệt'
                        ? 'canceld'
                        : 'pending'] + ' rounded-3xl px-5 py-2 border inline-flex items-center') },
        });
        (record.status);
    }
    if (column.dataIndex === 'actions') {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            type: "button",
            ...{ class: "w-6 h-6 rounded-full bg-[#1B4DEA] min-w-6 flex items-center justify-center cursor-pointer" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
            width: "16",
            height: "16",
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            type: "button",
            ...{ class: "w-6 h-6 rounded-full bg-[#1BB6EA] min-w-6 flex items-center justify-center cursor-pointer" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
            width: "16",
            height: "16",
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            type: "button",
            ...{ class: "w-6 h-6 rounded-full bg-[#E61B1B] min-w-6 flex items-center justify-center cursor-pointer" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
            width: "16",
            height: "16",
