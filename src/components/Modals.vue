  ...
  <transition name="modal-animation">
    <div v-show="modalActive" class="modal">
      <transition name="modal-animation-inner">
        <div v-show="modalActive" class="modal-inner w-full" :class="maxWidth">
          <div class="modal-content relative mx-4 w-full">
            <slot />
            <button type="button" class="absolute top-4 right-8 cursor-pointer max-md:right-4" @click="close">
