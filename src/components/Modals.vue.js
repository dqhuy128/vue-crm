...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "modal-inner w-full" },
    ...{ class: (__VLS_ctx.maxWidth) },
});
__VLS_asFunctionalDirective(__VLS_directives.vShow)(null, { ...__VLS_directiveBindingRestFields, value: (__VLS_ctx.modalActive) }, null, null);
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "modal-content relative mx-4 w-full" },
});
var __VLS_8 = {};
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...{ onClick: (__VLS_ctx.close) },
    type: "button",
    ...{ class: "absolute top-4 right-8 cursor-pointer max-md:right-4" },
});
...
var __VLS_dollars;
let __VLS_self;
//# sourceMappingURL=Modals.vue.js.map