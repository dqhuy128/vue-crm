...
const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({
    modelValue: (__VLS_ctx.FormSubmit.docCate),
}));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    id: "",
    value: (__VLS_ctx.FormSubmit.name),
    type: "text",
    name: "",
    placeholder: "Trợ lý",
...
var __VLS_58;
if (__VLS_ctx.fileUploadPreview) {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.textarea, __VLS_intrinsicElements.textarea)({
    id: "",
    value: (__VLS_ctx.FormSubmit.description),
    name: "",
...
//# sourceMappingURL=CreateDocument.vue.js.map