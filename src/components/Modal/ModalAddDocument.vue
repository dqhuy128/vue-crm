  ...
  >
    <div class="w-full max-w-md p-6 bg-white rounded-lg">
        ...
        >
          <div class="space-y-1 text-center">
            ...
            <div class="flex text-sm text-gray-600">
              <label
                class="relative font-medium bg-white rounded-md cursor-pointer text-main hover:text-main-dark focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-main"
              >
      ...
      <div class="flex justify-end space-x-3">
        ...
        <button
          @click="handleSubmit"
          class="px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md bg-main hover:bg-main-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-main"
        >
          Tải lên
        </button>
      </div>
