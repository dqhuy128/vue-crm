    ...
    <div class="grid grid-cols-12 gap-6">
      <div class="col-span-12 md:col-span-6">
        <div class="block">
          ...
          <input
            id=""
            v-model="paramsUserExplain.code"
            type="text"
            name=""
...
<script lang="ts" setup>
  ...
  const paramsUserExplain = reactive<typeParamsUserExplain>({
    ...
    created_at: props.datatype?.created_at || '',
  ...
  watch(
    ...
    (newVal) => {
      ...
      if (newVal) {
        ...
        paramsUserExplain.code = newVal.code || ''
        ...
        paramsUserExplain.created_at = newVal.created_at || ''
  ...
  const updateDates = () => {
    if (dateUserExplain.value) {
      paramsUserExplain.created_at = format(dateUserExplain.value, 'yyyy-MM-dd')
    }
  }
